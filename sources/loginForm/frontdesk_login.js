(function () {
  ...
  var VALID_USERNAME = 'frontdesk';
  var VALID_PASSWORD = 'frontdesk123';
  var form = document.getElementById('frontdeskLoginForm');
  ...
  form.addEventListener('submit', function (event) {
    ...
    if (username.value.trim() === VALID_USERNAME && password.value === VALID_PASSWORD) {
      sessionStorage.setItem('bb_frontdesk_authenticated', 'true');
      window.location.replace(new URL('frontdesk.html', document.baseURI).href);
      return;
    }
